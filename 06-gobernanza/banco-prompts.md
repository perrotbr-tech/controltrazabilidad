...
**Salvedad:** el manual Word `Sistema_Agentico_Mineria_SpecDriven.docx` y el ZIP original no venían en el paquete; se trabaja con su resumen operativo en el traspaso histórico.
